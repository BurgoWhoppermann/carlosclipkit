...
enum OnboardingHighlightID: Int, CaseIterable, Comparable {
    ...
    var description: String {
        ...
        case .exportSettings:
            return "Choose your format, size, and output folder here. Export stills, GIFs, and video clips — or all three at once."
        }
    }
            ...
            ZStack {
                ...
                case .guided:
                    if let rect = currentRect {
                        // Dark overlay with spotlight cutout — clicking outside dismisses
